...
import { IoStarSharp, IoTrashBin } from "react-icons/io5";
import { GlobalState } from "../context/GlobalState";
import { RiDraggable } from "react-icons/ri";
import { useSortable } from "@dnd-kit/sortable";


function TaskCard({ task, id, activeId , section}) {
  ...
  //   transition: transform ? 'transform 0.2s ease' : "none",
  //   // zIndex: transform ? 1000 : 0,
  //   willChange: 'transform', // Optional: performance optimization
  // };
  ...
  return (
      ...
      <li
        className="w-full min-h-40 bg-task-bg rounded-xl p-3 flex flex-col justify-between" style={{opacity: isDragging ? '0.5' : '1'}}
        ref={setNodeRef}
        // style={style}
      >
